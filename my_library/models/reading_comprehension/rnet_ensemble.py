...
from my_library.models.reading_comprehension.rnet import RNet
from allennlp.common import Params
from allennlp.data import Vocabulary
from allennlp.training.metrics import SquadEmAndF1

@Model.register("rnet-ensemble")
class RNetEnsemble(Ensemble):
    """
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'RNetEnsemble':  # type: ignore
        # pylint: disable=arguments-differ
        if vocab:
...
def ensemble(subresults: List[Dict[str, torch.Tensor]]) -> torch.Tensor:
    ...
    return RNet.get_best_span(span_start_probs.log(), span_end_probs.log()) # type: ignore
