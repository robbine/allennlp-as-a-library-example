...
class Transformer(Seq2SeqEncoder):
	...
	def encode(self, inputs, losses=None):
		...
		encoder_input, self_attention_bias, encoder_decoder_attention_bias = (
			self.transformer_prepare_encoder(inputs)
		)
		encoder_input = self._dropout(encoder_input)
		encoder_output = self.transformer_encoder(encoder_input, self_attention_bias, losses)
		return encoder_output, encoder_decoder_attention_bias

	def transformer_prepare_encoder(self, inputs, params, features=None):
	...
	def transformer_encoder(self, encoder_input, encoder_self_attention_bias, params, losses=None):
