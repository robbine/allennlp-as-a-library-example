...
@TextFieldEmbedder.register("basic_v2")
class BasicTextFieldEmbedderV2(TextFieldEmbedder):
    """
    ...
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'BasicTextFieldEmbedder':  # type: ignore
        ...
        return cls(use_fp16, token_embedders, embedder_to_indexer_map, allow_unmatched_keys)
