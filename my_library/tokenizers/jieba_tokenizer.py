...
from .jieba_splitter import JiebaWordSplitter
...
class JiebaTokenizer(Tokenizer):
    ...
    word_splitter : ``WordSplitter``, optional
        ...
        is to use the ``JiebaWordSplitter`` with default parameters.
    ...
    def __init__(self,
        ...
        self._word_splitter = word_splitter or JiebaWordSplitter()
